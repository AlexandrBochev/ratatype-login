  ...
  return (
    <div className="relative mb-[0.937rem] sm:mb-[1.25] font-medium text-darck_gray">
      <input
        id={ id }
        className={`
          w-full h-[3.75rem] sm:h-[4.375rem] border-[0.125rem] border-gray bg-ligth_gray rounded-[0.625rem] text-black py-[1.125rem] sm:py-[1.25rem] px-[0.9375rem]
          focus:outline-none focus:border-brand focus:pb-0 valid:pb-0 ${!isValid && 'border-red'}
        `}
        type={ type }
        required
